                ...
                <div class="flex">
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside text-sm mt-2">
                            ...
                            <li><strong>Jam Masuk & Pulang:</strong> Menentukan jam kerja standar dan validasi keterlambatan.</li>
                            <li><strong>Latitude & Longitude Kantor:</strong> Titik pusat lokasi kantor untuk validasi absensi via GPS. Anda bisa mendapatkan koordinat ini dari Google Maps.</li>
                            <li><strong>Radius Toleransi:</strong> Jarak maksimal (dalam meter) dari titik kantor di mana karyawan masih diizinkan untuk melakukan absensi.</li>                            
                        </ul>
                    </div>
                </div>
            </div>
