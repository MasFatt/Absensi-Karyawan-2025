            ...
            <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-6" role="alert">
                <div class="flex">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Pastikan pengajuan lembur dilakukan pada <strong>waktu istirahat</strong> yang telah
                            ditentukan. Lembur hanya akan disetujui untuk keperluan mendesak dengan <strong>alasan yang jelas
                            dan detail</strong>.
                        </p>
                    </div>
                </div>
                                ...
                                @forelse ($overtimes as $overtime)
                                    <tr class="text-center">
                                        <td class="py-2 px-4 border-b">
                                            {{ \Carbon\Carbon::parse($overtime->overtime_date)->format('d/m/Y') }}</td>
                                        ...
                                        <td class="py-2 px-4 border-b text-left">{{ $overtime->approver_notes ?? '-' }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-4">Belum ada riwayat pengajuan lembur.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
